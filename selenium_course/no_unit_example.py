...
def test_eception2():
    try:
        ...
        browser.get('https://easysmarthub.ru/kak-ustanovit-selenium-webdriver-na-windows-i-zapustit-lokalnoe-okruzhenie-python-v-vs-code/')
        with pytest.raises(NoSuchElementException):
            browser.find_element(By.CSS_SELECTOR,"a#molodec") #верный - то есть будет красным поскольку кнопка действительно есть на сайте
            pytest.fail('Не должна отображаться кнопка ЧУДО на странице2')
